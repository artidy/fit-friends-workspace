...
function LookForCompanyComponent(): JSX.Element {
  return (
      ...
      <ul className="look-for-company__list">
        <li className="look-for-company__item">
          <div className="thumbnail-user thumbnail-user--role-user thumbnail-user--dark">
            <div className="thumbnail-user__image">
              <picture>
                ...
                <img
                  ...
                  srcSet="img/content/thumbnails/user-04@2x.jpg 2x" width="82" height="82" alt="" />
              </picture>
            </div>
            ...
            <a className="btn btn--outlined btn--dark-bg btn--medium thumbnail-user__button"
               href="#">Подробнее</a>
          </div>
        </li>
        <li className="look-for-company__item">
            ...
            <div className="thumbnail-user__image">
              <picture>
                ...
                <img
                  ...
                  srcSet="img/content/thumbnails/user-05@2x.jpg 2x" width="82" height="82" alt=""
                />
              </picture>
            </div>
            <div className="thumbnail-user__header">
            ...
            <div className="thumbnail-user__image">
              <picture>
                ...
                <img
                  ...
                  srcSet="img/content/thumbnails/user-06@2x.jpg 2x" width="82" height="82" alt=""
                />
              </picture>
            </div>
            <div className="thumbnail-user__header">
            ...
            <div className="thumbnail-user__image">
              <picture>
                ...
                <img
                  ...
                  srcSet="img/content/thumbnails/user-07@2x.jpg 2x" width="82" height="82" alt=""
                />
              </picture>
            </div>
            <div className="thumbnail-user__top-status thumbnail-user__top-status--role-user">
...
export default memo(LookForCompanyComponent);
